...
.chat-wrapper {
  ...
  .chat {
    ...
    .by {
      display: flex;
      margin-bottom: $size-3;
      .photo-container, .button.reply {
        $wh: 2.3rem;
        width: $wh;
        height: $wh;
      }
      .button.reply { padding: $size-2; }
      .photo-container { margin-bottom: $size-1; }
      .text-wrapper {
        .bubble {
          width: fit-content;
          max-width: 83%;
      ...
      &.me {
        ...
        .text-wrapper {
          ...
          &:first-child .bubble { border-top-right-radius: 0; }
        }
      }
      &.other {
        .text-wrapper {
          ...
          &:first-child .bubble { border-top-left-radius: 0; }
        }
      }
    }
  }
